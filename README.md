...
# Setting up access to private subnet
  - connect private subnet to public subnet
    - allow private subnet resources to access public subnet resources by specifying the public subnet CIDR in the private subnet security group
    - instance in public subnet can access instance in private subnet through private subnet's instance private IP
    - in public subnet's instance with app, navigate to within the app folder and specify the MongoDB environment variable
